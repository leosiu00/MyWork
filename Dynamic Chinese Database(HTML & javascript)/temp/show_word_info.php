...
{
   echo '<button class="tablinks" onclick="openTab(event,'."'".$row0['Describ']."'".')">'.$row0['Describ'].'</button><button id="new" style="float:right">新增</button>'." ";
}
echo '</div>' ; 
echo '<br>' ;
...
while($row0 = mysql_fetch_array($result0, MYSQL_ASSOC))
{
  echo '<div><div id="'.$row0['Describ'].'" class="tabcontent"><div id="edit" style="float:right">修改</div>' ;
