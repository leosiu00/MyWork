...
$query3 = "SELECT * FROM base_2 WHERE Base like '%".$target."%' ;" ;
$result3 = mysql_query($query3) or die( "Unable to execute query:".mysql_error());
...
$target4 = '好人';
$query4 = "SELECT * FROM base_2 WHERE Base like '%".$target."%' ;" ;
$result4 = mysql_query($query3) or die( "Unable to execute query:".mysql_error());
